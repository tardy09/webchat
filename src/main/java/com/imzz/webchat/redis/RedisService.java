...
import com.imzz.webchat.entity.Operate;
import com.imzz.webchat.entity.RedisInfoDetail;
import com.imzz.webchat.utils.RedisUtil;
	...
	public Map<String,Object> getMemeryInfo() {
		...
		for (int i = 0; i < strs.length; i++) {
			...
			if (detail[0].equals("used_memory")) {
				...
				map.put("create_time",System.currentTimeMillis()/1000L);
				break;
			}
		}
		return map;
