...
public class VerifyCodeUtil {
    ...
    public static BufferedImage generateImageCode(String textCode, int width, int height, int interLine, boolean randomLocation, Color backColor, Color foreColor, Color lineColor){
        ...
        int fy = fsize;
        //设定字体
        graphics.setFont(new Font("Times New Roman", Font.LAYOUT_LEFT_TO_RIGHT, fsize));
        //写验证码字符
     ...
     * @return
     */
    public static Boolean isRepeat(List<String> str){
        //先排序
    ...
    public static Set<HashMap<String,String>> removeTheSameValue(String[] str1,String[] str2){
        //创建一个存储值
        ...
        //对小区的值进行去重
        Set<HashMap<String,String>> keysSet = new HashSet<>();
    ...
    public static void main(String[] args) {
        String[] str1 = {"1","2","3","4","5","6","1"};
        String[] str2 = {"我","是","邹","智","敏","哦","我"};
        removeTheSameValue(str1,str2);
    }
