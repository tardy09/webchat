...
;layui.define("view", function(e) {
    var a = layui.jquery
      ...
      , A = {
        ...
        sideFlexible: function(e) {
            ...
            s < 2 ? i.addClass(v) : i.removeClass(v),
            i.removeClass(C)) : (t.removeClass(g).addClass(x),
            s < 2 ? i.removeClass(C) : i.addClass(C),
            i.removeClass(v)),
      ...
      , _ = A.events = {
            ...
            _.note.index = A.popup({
                ...
                success: function(e, a) {
                    var t = e.find("textarea")
                      , s = void 0 === i ? "便签中的内容会存储在本地，这样即便你关掉了浏览器，在下次打开时，依然会读取到上一次的记录。是个非常小巧实用的本地备忘录。正在开发中....." : i;
        ...
        closeOtherTabs: function(e) {
            ...
            a(z).eq(0).trigger("click")) : (a(z).each(function(e, t) {
                e && e != A.tabsPage.index && (a(t).addClass(i),
                A.tabsBody(e).addClass(i))
            }),
            a("." + i).remove())
        },
    ...
    var L = layui.data.resizeSystem = function() {
        ...
        L.lock || setTimeout(function() {
            A.sideFlexible(A.screen() < 2 ? "" : "spread"),
            delete L.lock
        }, 100),
        L.lock = !0
    }
